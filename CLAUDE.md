...
PROJECT TITLE: The game is **Gradebreaker** (one word, capital G; decided 2026-09-10). Cover block: "GRADEBREAKER / The LitRPG RPG / Power is not granted." The subtitle "The LitRPG RPG" is locked; the tagline stays the Principles chapter's closing line and is off the cover for now (Gabriel, 2026-09-13). The cover also carries "The F-Grade Volume" and, until release, a working-draft date. There is no separate engine name. "LitRPG: RPG" and older titles are legacy; don't use them in new content.
