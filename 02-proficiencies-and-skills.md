...
For opposed checks (e.g., intimidation pitting the aggressor's CHA Force against the target's HRT Force), both sides roll d100 + their Force, higher wins. For passive obstacles (e.g., deciphering a script), the GM assigns a Resistance from the Grade Reference Card.
