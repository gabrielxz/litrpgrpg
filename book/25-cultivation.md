...
- **Recharges:** Items that recharge "at the next Consolidation" (the Reactive Buckler and similar) and effects usable once per Consolidation (such as a title's) reset when the first full hour completes, on the same clock as Aether.
