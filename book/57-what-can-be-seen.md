...
Looking at another Integrated being tells you something, and how much depends almost entirely on the gap between you. Looking is a glance within sight and costs no Beat.
...
That narrow window is worth more than it looks. Knowing an ally's true condition changes every triage decision at the table, and it is the reason strangers in this genre form a party before they trust each other: the frame provides reliable resource information even between strangers. The full rules for forming a party are in System Quests.

---

## What Nobody Sees

**The Hidden Vector Engine is invisible to everyone.** Not to other players, not to inspection at any Grade differential, and not to the character it describes. No instrument shows its axes or its numbers and no title reveals them; mirrors and visions show the System's reading of a person in images, and those can be wrong. A character can infer their own pattern the way anyone infers their own character, by noticing what they keep doing, and that inference is exactly as reliable as it is in life.
