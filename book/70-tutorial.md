...
| **The Kith**: Kes the scout, Nemi, Sava, and Tovan | Phase 4: The Arriving Initiates, though Kes's tally on the slopes is met earlier (Phase 2, The Tally) | Fight beside the party in Phase 5 and name the Warden's weak point | The party enters Phase 5 without their warning and without allies |
...
**These mechanics can arrive before their scheduled introduction.** A natural 96 can explode in the first Clash of Phase 2, an attacker who wins by 40 or more has Driven Back whenever it happens, and you can grant Advantage in any fight. When one arrives early, apply it, name it, and explain it briefly; skip its planned introduction later.
...
**Run this one-on-one.** Run each character's scene privately if you can, in another room or by direct message.
...
Adapt the landing to the probe's Echo. A character set down gently does not hit the ground; a character who landed on their feet is already standing. The last box below belongs to a character whose arrival creature is already close; for a character whose encounter comes first, end on the sky.
...
If a character explores the void, describe one response from it (the pressure of the others, or the notice turning toward them) and move to the fall.
...
**Each rotation has the same shape.** The character wakes into one encounter from the list below, resolves it, fights their arrival creature, and scavenges on the walk down.
...
- **Try to communicate (CHA Force vs. F-Easy 65).** You get nothing like language. What you get is that it wants you to wait. Wait about a minute of table time and it finishes, goes still, and the stone comes away warmer than it was. Awards the core plus **+1 IP toward the Preservation family**, and seeds the Hidden Quest *"Let It Finish"*; reveal it in Phase 6. The core and the IP are separate awards.
...
**Any one of the three inputs opens it.**
...
- **Wait it out.** Let a short silence run at the table, then describe the column letting go one long pulse. Grants **+1 IP** toward the Principle family the character's behavior points to (The Principle System, "Your First Principle"). This is also a **Battle Memory** trigger; note it for the Consolidation at the end of the Ruins.
...
- **Break it.** Its parts pay two peer kills' worth of VE (20).
- **Get out of its way.**
...
- **Add to the tally.** Note it as scene bookkeeping for Phase 4, and consider it at the session-end sweep like any other choice. Kes saw it.
- **Destroy the tally.** Note that too. It was the only record of forty-one arrivals, and its maker meets the party in two days.

**Developments.** Carry the answer into Phase 4. If someone added to the tally, Kes approaches that character first and communication starts warmer. If the tally was destroyed, Kes keeps their distance from that character and communication starts colder. Say neither out loud; if the party gets communication working, the party can learn why Kes treats that character differently.
...
**The characters land apart, and the party cannot choose otherwise.** Say so at setup if a player asks.
...
There are other people here. Standing well apart, watching each other, in work clothes and pajamas and one man in a wetsuit.
:::
...
**Play the invitation out loud, as one character inviting another.** Who extends it, who accepts at once, and who stays solo are moments for the sweep.
...
| 1 **Reactive Buckler** | Once between Consolidations, reduce one physical hit to zero damage without giving up Beats. |
...
**The Resonance Shard.** Everything else in the pile is usable today. The Resonance Shard is one point of insight toward a Principle the character has not formed and cannot yet evaluate; a character who gathers 3 IP can crystallize a Principle before the tutorial ends, and this shard is a third of the way. Say what the System says, in its own units: *Resonance Shard. Insight: +1 on meditation. Principle: undetermined.* Tell the players what the shard does; only the Principle it feeds stays hidden (Items chapter, "Outfitting the Tutorial"). Note who takes it and any reason they give.

**Three kinds of thing come out of this pile,** a distinction worth keeping for the rest of the campaign, because these three are what a classless character has instead of a class (classes arrive at Level 10; Progression):
...
- **Equipment.** Weapons and armor. A weapon carries no bonus of its own; it decides which Force governs and what becomes possible, and Marks earned with it go to that weapon's Proficiency. Armor's modifiers are listed on it.
- **Principle progress.** The Resonance Shard, and the affinity treasures that follow it. IP toward a Principle, earned before the Principle forms.
...
Aura Pressure and the Attribute Treasure live in Sector B, and the Wraith in Sector C. A party that skips those sectors meets those mechanics later in the campaign; the tracker at the end of the chapter lists them as contingent.
...
- **Locked armory** behind a Sentry. The door opens once that Sentry is destroyed, or while the Sentry is driven off the doorway. Contents: 1 Battle Axe, 1 Reactive Buckler, 2 Lesser Healing Pills, 1 Anchor Shard.
...
**Teaching Driven Back.** The arena's tiers are a two-meter drop onto sand. When a player wins a Clash by 40 or more, tell them what they have earned: the Sentry is Exposed until the end of its next turn, and they may drive it one Zone. Off the tier is a Zone. So is away from the ally it was about to hit, and out of the armory doorway it was blocking. A Sentry driven into another Zone is out of melee reach for the character's follow-up. Driving it is worth more than an extra swing when the doorway or the ally matters.
...
- **Resonance chamber.** A character can temporarily borrow a dead technique. Arcane power flows through them, unstable and intoxicating. Improvise a technique priced against the Modifier Budget (a +10 Clash effect or similar, 1 Beat), usable once during the next combat.
- **Broken constructs**, partially reactivatable by characters who experiment (PER vs. F-Hard 115). On a success, the construct fights for the party for 3 rounds (Off Force 12, Def Force 15, HRT Force 05, PER Force 07, HP 30).
...
The building was occupied until recently. Bedding, ration wrappers, and a scrawled tally on one wall show where a group lived for sixteen days before the Husk Sentinel drove them out. That group is the one arriving at the party's camp (see The Arriving Initiates, below); a party that comes here first meets the building empty and works out the story backward.
...
- **Tribunal chamber.** The automated arbitration system still partly functions. A character who works out the protocol (CHA Force vs. F-Hard 115) can put a dispute to it and receive a formal decision, which the System records against every party to it. Nothing enforces the decision outside the building; the System may quote it in later offers.
...
A party that wants the second sector before the dissolution starts can break camp Saturated. Say what their bodies are telling them and let them decide.
...
**Kes and the tally.** Kes cut the tally the party may have met on the slopes (Phase 2, The Tally) and knows what each character did there. If somebody added to the tally, Kes approaches that character first and communication starts warmer. If somebody destroyed the tally, Kes keeps their distance from that character and communication starts colder. Say neither out loud; if the party gets communication working, the party can learn why Kes treats that character differently. Anything the party abandoned in Phase 2 is fair salvage: a cache left unopened has been stripped, and its buckler rides on Kes's arm.
...
Where you can, stage the negotiation at the party's own fire, with the party's supplies on the ground between them.
...
These are formal **Personal Opportunities** (see System Quests). None has a prescribed answer.
...
- **The seed.** It cannot be used now. During the next Consolidation it germinates: the GM, or the System AI in assisted modes, chooses a Principle family, and the character gains **+2 IP** toward it and one permanent Attunement, which a Principle otherwise grants only from Seed tier (The Principle System, "Attunements").
...
- **Accept the technique memory.** The character receives a Battle Memory of the mind's final technique, and no usable ability. Accepting pays **+1 IP** on the spot toward the Harmony family, and the meditation pays 1 to 3 IP like any memory.
- **Harvest the matrix for raw energy.** The consciousness dissipates screaming. **A full level's worth of VE (120)**.
- **Free the consciousness.** The matrix releases, and it expresses something like gratitude before dissolving into ambient energy. **+1 IP** toward the Preservation family. Freeing it also completes the Hidden Quest *"Let It Finish"* for a character who did not complete it at the Dying Scavenger.
...
- **Help.** The Initiate is a System construct, and the danger was staged. Reward: a **Bestowed title** delivered in Phase 6 ("The Hand That Reached").
...
- **Open it.** The door has no lock; it opens to a hand on it. A brief vision of an E-Grade location; give it one concrete image. Will Save: d100 + HRT Force vs. Aura Resistance Hard (115), the flaring value. For most characters the save fails unless the die explodes: a natural 96 or higher rolls again, and with HRT 5 the second die needs 14 or better. On failure: **Suppressed for the rest of the tutorial (1 Beat; this scene's own term)**. On success the character stands in it and takes no penalty. Either way, opening it earns the Achievement title **Not Recommended** (+1 HRT), delivered in Phase 6.
- **Walk away.**

#### Running Them

Nobody revises an answer after seeing how someone else's went. After a card comes back, deliver one private line:
...
Every F-Grade character has a VE Tolerance of **80**: Mild Saturation begins past 80 and Heavy past 160, and one sector of the Ruins pays about 120, so a hard afternoon reaches the first band on its own. The thresholds are printed on the character sheet.
...
- **Battle Memories are meditated on.** Anyone holding a card from the Resonance Node, the Resonance Flicker, a Volatility cascade, or a Personal Opportunity reflects now. The player describes what their character noticed in a sentence or two. Ask one or two questions and give the answer room. Compose the vision the System returns (unplugged, three images; The System AI) and award **1 to 3 IP** by the memory's intensity, toward the character's Principle family. A card converts to IP once, at this meditation; the +1 IP some triggers award on the spot (the Flicker, the Resonance Node, the Trapped Intelligence) is a separate award. A character reaching 3 IP **crystallizes their first Principle here**: you name it, and the System announces it (The Principle System, "Your First Principle"). Run it slowly for whoever earns it; it is the largest payoff available before the tutorial ends.
...
A typical character reaches **Level 2 or 3** here. Use each character's actual stored VE to see whether they are still Saturated at dawn. Anyone still over Tolerance can extend the rest into the morning.
...
**The Situation.** The valley is being taken apart on a schedule. The only way out is the gate at the center, visible since they landed, and between them and it is the Corrupted System Warden, which they cannot beat in a straight fight. They want to reach the gate. The phase ends when everyone who can reach the gate is through, or the sector closes.
...
Read this aloud. Show the timer. From this moment the timer is fixed: thirty minutes of fictional time, spent in scenes on the approach and counted in rounds on the causeway (The Crossing, by Rounds). Say what the failure line means: an Initiate still inside the sector when the Purge reaches the gate is gone.
...
The approaches below can each help the party reach the gate. A party that played two sectors has two or three of the rows below. The table lists the likely applications and what each buys; players may propose others the fiction supports, and each earns a benefit the size of one row.
...
Fighting the Warden on open ground before the causeway leaves room to retreat, and a party that works that out has an easier crossing.
...
- At the sweep, tally this as a **Defining** moment.
...
Then the System pulls them through: an Initiate lost to an administrative overrun is a processed asset wasted. The recovery is rough and incomplete. The character arrives on the far side of the gate on their hands and knees, carrying the Salvaged title and its effects.
...
- **Release:** be the last of a group out of a collapsing, closing, or pursued situation, and get out under their own power.
...
Explain the penalty and the release condition to the player, and give the character a later chance to meet the condition. The System's notice blames the sector and penalizes the character anyway; play the contradiction as part of the System's character.
...
**Character death in the tutorial.** No player character dies in this tutorial except by the sacrifice on the causeway. Where a result would otherwise kill a player character (a Downed countdown running out with nobody near, a single hit at ten times Max HP), the character is Downed at 0 HP instead, and something intervenes before the count ends: a creature loses interest, an ally arrives, or, at the gate, the System pulls them through (Salvaged, above). NPCs have no such protection, and several of them can die in these three days. Tell the players this rule if they ask.

The tutorial should end with the party through.

**VE Reward.** The Warden and anything killed on the run pay their tiers as they fall. The Mandate itself pays on completion, past the gate: 125 VE, the Hard Mandate award (System Quests, "VE Rewards by Quest Category and Difficulty"), and the largest single award in the tutorial.
...
After the party's thirty minutes, the System speaks formally, at more length than it has all tutorial:
...
Levels arrive the way they always will: at Consolidation, as refined VE crosses each threshold (Progression chapter). This rest is the tutorial's longest: real ground, no pursuing threat, and much of the tutorial's VE still unrefined. After the Mandate and completion awards, work out each character's stored VE and Saturation band. A character carrying two sectors' worth plus the Mandate is Critical, and the collapse roll runs hourly for them (Cultivation); one who refined at every camp may be only Mild. Let the party begin Consolidating when it chooses. Running the recognition scene for an hour in the fiction puts a Critical character on the collapse clock; if a collapse comes, it costs 1 temporary Raw point of FOR or POW (player's choice) and the character sleeps where they fell. Let the rest run as long as the fiction allows, which here is a full day or more of camp, and process the backlog.
...
Run the levels one at a time, one player at a time.
...
The campaign from here to the Level 25 cap is After the Gate.

---

## GM Reference: The Session-End Sweep

Nothing is written during play. At each session's end, take five minutes with the HVE sheet (The Hidden Vector Engine, "The Session-End Sweep"): name the session's three biggest moments out loud and say what they share, then tally, privately, what you remember for each character.
...
| The first Yield decision | How they meet a damaging hit: Yield one Beat, Yield two, or take the full hit |
...
- **Front-loading mechanics.** Players learn Clashes by clashing, Zones by moving, Beats by running out of them, and Yield by nearly dying.
...
- **Killing a player character by accident.** The survival rule (Phase 5, Watch For) and the tutorial's escape routes keep accidental defeat from killing a player character: Yield in the arrivals, a non-combat path past every threat sized above a fresh party (Threat Calibration), and Salvage at the gate (Salvaged). The one player-character death available is the one a player chooses on the causeway, and it is honored when they take it (Phase 5, Watch For).

- **Overstaying its welcome.** Two sessions of the default length, or four short ones.

- **Telegraphing the tutorial's titles.** "Thin Margin," "Not Recommended," "The One Who Stood": revealed retroactively. Players should never feel they were grinding toward one.
